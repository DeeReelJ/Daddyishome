        ...
        var t = (function (u) {
            var f = /\blang(?:uage)?-([\w-]+)\b/i,
                ...
                O = {
                    ...
                    highlight: function (e, t, n) {
                        ...
                        return O.hooks.run("before-tokenize", i), (i.tokens = O.tokenize(i.code, i.grammar)), O.hooks.run("after-tokenize", i), L.stringify(O.util.encode(i.tokens), i.language);
                    },
                                ...
                                for (var s in i)
                                    if (i.hasOwnProperty(s) && i[s]) {
                                        ...
                                        for (var u = 0; u < l.length; ++u) {
                                            ...
                                            for (var m = f.pattern || f, v = r.next, y = o; v !== n.tail && !(a && y >= a.reach); y += v.value.length, v = v.next) {
                                                var b = v.value;
                                                ...
                                                if (!(b instanceof L)) {
                                                    var _,
                                                        w = 1;
                                                    if (h) {
                                                        if (!(_ = P(m, y, t, d))) break;
                                                        var x = _.index,
                                                            E = _.index + _[0].length,
                                                            T = y;
                                                        for (T += v.value.length; T <= x; ) (v = v.next), (T += v.value.length);
                                                        if (((T -= v.value.length), (y = T), v.value instanceof L)) continue;
                                                        for (var C = v; C !== n.tail && (T < E || "string" == typeof C.value); C = C.next) w++, (T += C.value.length);
                                                        w--, (b = t.slice(y, T)), (_.index -= y);
                                                    } else if (!(_ = P(m, 0, b, d))) continue;
                                                    var x = _.index,
                                                        S = _[0],
                                                        k = b.slice(0, x),
                                                        A = b.slice(x + S.length),
                                                        D = y + b.length;
                                                    a && D > a.reach && (a.reach = D);
                                                    var N = v.prev;
                                                    k && ((N = I(n, N, k)), (y += k.length)), F(n, N, w);
                                                    var j = new L(s, c ? O.tokenize(S, c) : S, p, S);
                                                    (v = I(n, N, j)), A && I(n, v, A), 1 < w && e(t, n, i, v.prev, y, { cause: s + "," + u, reach: D });
                                                }
                                            }
                                        }
                                    }
            ...
            if (
                ...
                (L.stringify = function t(e, n) {
                    ...
                    var r = { type: e.type, content: t(e.content, n), tag: "span", classes: ["token", e.type], attributes: {}, language: n },
                        o = e.alias;
                    o && (Array.isArray(o) ? Array.prototype.push.apply(r.classes, o) : r.classes.push(o)), O.hooks.run("wrap", r);
                    var a = "";
                            ...
                            u.addEventListener(
                                ...
                                function (e) {
                                    var t = JSON.parse(e.data),
                                        ...
                                        i = t.code,
                                        r = t.immediateClose;
                                    u.postMessage(O.highlight(i, O.languages[n], n)), r && u.close();
                                },
                                !1
                            )),
                    O
    ...
    (Prism.languages.clike = {
        ...
        Prism.languages.insertBefore("javascript", "keyword", {
            regex: {
                ...
                lookbehind: !0,
                greedy: !0,
                inside: { "regex-source": { pattern: /^(\/)[\s\S]+(?=\/[a-z]*$)/, lookbehind: !0, alias: "language-regex", inside: Prism.languages.regex }, "regex-flags": /[a-z]+$/, "regex-delimiter": /^\/|\/$/ },
            },
            "function-variable": {
        ...
        r(function () {
            ...
            t.start(),
                t.addEventListener("secondsUpdated", function (e) {
                    r("#basicUsage").html(t.getTimeValues().toString());
                });
        }),
        r(function () {
            var t = new e();
            t.start({ precision: "seconds" }),
                t.addEventListener("secondsUpdated", function (e) {
                    r("#gettingValuesExample .days").html(t.getTimeValues().days),
                        r("#gettingValuesExample .hours").html(t.getTimeValues().hours),
                        r("#gettingValuesExample .minutes").html(t.getTimeValues().minutes),
                        r("#gettingValuesExample .seconds").html(t.getTimeValues().seconds),
                        r("#gettingValuesExample .secondTenths").html(t.getTimeValues().secondTenths),
                        r("#gettingTotalValuesExample .days").html(t.getTotalTimeValues().days),
                        r("#gettingTotalValuesExample .hours").html(t.getTotalTimeValues().hours),
                        r("#gettingTotalValuesExample .minutes").html(t.getTotalTimeValues().minutes),
                        r("#gettingTotalValuesExample .seconds").html(t.getTotalTimeValues().seconds),
                        r("#gettingTotalValuesExample .secondTenths").html(t.getTotalTimeValues().secondTenths);
                });
        }),
        r(function () {
            var t = new e();
            r("#chronoExample .startButton").click(function () {
                t.start();
            }),
                r("#chronoExample .pauseButton").click(function () {
                    t.pause();
                }),
                r("#chronoExample .stopButton").click(function () {
                    t.stop();
                }),
                r("#chronoExample .resetButton").click(function () {
                    t.reset();
                }),
                t.addEventListener("secondsUpdated", function (e) {
                    r("#chronoExample .values").html(t.getTimeValues().toString());
                }),
        ...
        r(function () {
            var t = new e();
            t.start({ precision: "seconds", startValues: { seconds: 90 }, target: { seconds: 120 } }),
                r("#startValuesAndTargetExample .values").html(t.getTimeValues().toString()),
                t.addEventListener("secondsUpdated", function (e) {
                    r("#startValuesAndTargetExample .values").html(t.getTimeValues().toString()), r("#startValuesAndTargetExample .progress_bar").html(r("#startValuesAndTargetExample .progress_bar").html() + ".");
                }),
                t.addEventListener("targetAchieved", function (e) {
                    r("#startValuesAndTargetExample .progress_bar").html("COMPLETE!!");
                });
        }),
        r(function () {
            var t = new e();
            t.start({ countdown: !0, startValues: { seconds: 15 } }),
                r("#countdownExample .values").html('Wait ' + t.getTimeValues().seconds),
                t.addEventListener("secondsUpdated", function (e) {
                    // r("#countdownExample .values").html(t.getTimeValues().toString());
                    r("#countdownExample .values").html('Wait ' + t.getTimeValues().seconds);
                }),
                t.addEventListener("targetAchieved", function (e) {
                    r("#countdownExample .values").html("");
                    document.getElementById('confirmBtn').disabled = false;
                    document.getElementById('confirmBtn').style.marginLeft = '42px';
                });
        }),
        r(function () {
            new e().start({
                callback: function (e) {
                    r("#callbackExample .values").html("Hello, I am a callback and I am counting time: " + e.getTimeValues().toString(["days", "hours", "minutes", "seconds", "secondTenths"]));
                },
            });
        }),
        r(function () {
            ...
            t.start({ precision: "secondTenths" }),
                t.addEventListener("secondTenthsUpdated", function (e) {
                    r("#secondTenthsExample .values").html(t.getTimeValues().toString(["hours", "minutes", "seconds", "secondTenths"]));
                });
        }),
        r(function () {
            var t = new e({ countdown: !0, startValues: { seconds: 5 } });
            t.start({ startValues: { seconds: 30 }, target: { seconds: 10 } }),
                r("#defaultParamsExample .values").html(t.getTimeValues().toString()),
                t.addEventListener("secondsUpdated", function (e) {
                    r("#defaultParamsExample .values").html(t.getTimeValues().toString());
                }),
                t.addEventListener("targetAchieved", function (e) {
                    r("#defaultParamsExample .values").html("The bomb has been defused!");
                });
        });
})();
